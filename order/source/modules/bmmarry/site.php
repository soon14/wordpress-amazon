...
class bmmarryModuleSite extends WeModuleSite {
	public $headtable='bmmarry_list';
	public $listtable='bmmarry_info';
	public $reply_table='bmmarry_reply';
	...
	public function doWebAdd() {
		...
		if (checksubmit('submit')) {
			...
			$data = array(
					...
					'art_pic'=>	$_GPC['art_pic'],	
					'first_pic'=>	$_GPC['first_pic'],	
					'donghua_pic'=>	$_GPC['donghua_pic'],	
					'suolue_pic'=>	$_GPC['suolue_pic']			
			);
			/* //上传图片
 ...
 */
	...
	//-o
			...
			message('喜帖信息更新成功！', create_url('site/module/manager', array('name' => 'bmmarry')), 'success');
		...
		if ($op == 'pwd' && $pwd1<>'' && $pwd2<>'') {
			...
			if($pwd==$ipwd)	{		
				if ($pwd1==$pwd2) {
					...
					message('密码已成功修改！', create_url('mobile/module/detail', array('name' => 'bmmarry','id' => $id,'weid' => $_W['weid'])), 'success');									
				} else {
	...
	public function geturl($type=1)
	{
		...
		{
			case 1:
				$img_url='./source/modules/bmmarry/template/img/art_pic.png';
				break;
			case 2:
				$img_url='./source/modules/bmmarry/template/img/open_pic.jpg';
				break;
			case 3:
				$img_url='source/modules/bmmarry/template/img/open_pic.jpg';
				break;
			case 4:
				$img_url='./source/modules/bmmarry/template/img/YouGotMe.mp3';
				break;
			default:
				$img_url='./source/modules/bmmarry/template/img/art_pic.png';
		}
