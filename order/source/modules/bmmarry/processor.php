...
class bmmarryModuleProcessor extends WeModuleProcessor {
    
	public $name = 'bmmarryModuleProcessor';
	public $table_reply = 'bmmarry_reply';
	public $table_list='bmmarry_list';
	...
	private  function getpicurl($url)	
	{
		...
		{
			return $_W['siteroot'].'source/modules/bmmarry/template/img/art_pic.png';
		}
	}
}
