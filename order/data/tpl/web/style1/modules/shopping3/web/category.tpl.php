...
<ul class="nav nav-tabs">
	<li <?php  if($operation == 'post') { ?>class="active"<?php  } ?>><a href="<?php  echo $this->createWebUrl('category', array('op' => 'post'))?>"><?php  if($id==0) { ?>添加分类<?php  } else { ?>修改分类<?php  } ?></a></li>
	...
	<input type="hidden" name="parentid" value="<?php  echo $parent['id'];?>" />
		...
		<table class="tb">
			...
			<tr>
				...
				<td>
					<input type="text" name="displayorder" class="span2" value="<?php  echo $category['displayorder'];?>" />
				</td>
			</tr>
			<tr>
