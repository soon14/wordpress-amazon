...
<title><?php  if(empty($_W['setting']['copyright']['sitename'])) { ?>微盒微信- 微信营销管理平台 -  Powered by wxbox.cn<?php  } else { ?><?php  echo $_W['setting']['copyright']['sitename'];?><?php  } ?></title>
        <!--[if IE 7]>
...
<div id="main">
	...
	<div style="width:100%;text-align:center;font-size:14px;color:#ff0000;display:none;">微盒 -  2.0</div>
	</body>
	<script>
