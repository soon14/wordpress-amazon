...
<body>
  ...
  <section id="page-index" class="__page__" style="display: block;">
				...
				<div class="lewaimai-layout">
					...
					<div class="shopinfo-content">
						<div class="shopinfo-item">
							...
							<p class="shopinfo-value"><a href="tel:<?php  echo $set['shop_tel'];?>"><?php  echo $set['yy_start_time'];?>-<?php  echo $set['yy_end_time'];?></a></p>
						</div>
		...
		<div id="footer_menu" class="footer footer_menu">
            <ul class="clear">
				<li><a  href="<?php  echo  $this->createMobileUrl('wlindex')?>" class="onactive" ><span class="icons icons_4"></span><label>店铺首页</label></a></li>		
