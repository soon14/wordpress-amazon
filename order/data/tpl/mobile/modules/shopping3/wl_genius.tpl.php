...
<body id="page_count">
    ...
    <div class="notice">
		...
		<div id="footer_menu" class="footer footer_menu">
            <ul class="clear">
				<li style="width:20%"><a  href="<?php  echo  $this->createMobileUrl('wlindex')?>"><span class="icons icons_4"></span><label>店铺首页</label></a></li>	
				<li style="width:20%"><a  href="<?php  echo  $this->createMobileUrl('wlindex')?>" ><span class="icons icons_2"></span><label>开始选购<label></a></li>
