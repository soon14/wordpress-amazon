<?php defined('IN_IA') or exit('Access Denied');?>		<div id="footer_menu" class="footer footer_menu">
            <ul class="clear">
                <li><a href="<?php  echo  $this->createMobileUrl('wlhome')?>"     <?php  if($_GPC['do']=='wlhome') { ?>class="onactive"<?php  } ?>><span class="icons icons_4"></span><label>店铺首页</label></a></li>
				 <?php  if(($_GPC['do']!='wlmember' && $_GPC['do']!='wlorder'&& $_GPC['do']!='wlmylike' && $_GPC['do']!='wlhome'  && $_GPC['do']!='wlgenius' )) { ?>
                <li><a href="<?php  echo  $this->createMobileUrl('wlindex')?>" class="onactive" ><span class="icons icons_2"></span><label>开始选购</label></a></li>
				<?php  } else { ?>
