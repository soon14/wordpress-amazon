	...
	if($ispost) {
		...
		if (empty($error_msg)) {
			...
			if($_POST['install'] == 'remote') {
				...
				if($ins['error']) {
					die('<script type="text/javascript">alert("链接微服务更新服务器失败, 错误为: ' . $ins['error'] . '！");history.back();</script>');
				}
...
VER;
				...
				if(file_exists(IA_ROOT . '/index.php') && file_exists(IA_ROOT . '/setting.php') && file_exists($verfile)) {
					...
					die('<script type="text/javascript">alert("你正在使用本地安装, 但未下载完整安装包, 请从微服务官网下载完整安装包后重试.");history.back();</script>');
				}
			}
...
<title>微服务 - 微信公众平台自助开源引擎</title>
<link href="./resource/WFW/css/install.css" rel="stylesheet" type="text/css" />
...
<div class="header">
	<div class="top">
		...
		<div class="top-link">
			<ul>
				<li><a href="http://www.weixfu.cn" target="_blank">微服务官方网站</a></li>
...
function tpl_install_license() {
	echo <<<EOF
		...
		<div class="pr-agreement">
				<p>版权所有 (c)2013，微服务团队保留所有权利。 </p>
				<p>感谢您选择微服务 - 微信公众平台自助开源引擎（以下简称WFW，WFW基于 PHP + MySQL的技术开发，全部源码开放。</p>
				<p>为了使你正确并合法的使用本软件，请你在使用前务必阅读清楚下面的协议条款：</p>
			<strong>一、本授权协议适用且仅适用于WFW任何版本，WFW官方对本授权协议的最终解释权。</strong>
			...
			<strong>二、协议规定的约束和限制 </strong>
				...
				<p>4、未经官方许可，禁止在 WFW的整体或任何部分基础上以发展任何派生版本、修改版本或第三方版本用于重新分发。</p>
			...
			<strong>三、有限担保和免责声明 </strong>
				...
				<p>3、电子文本形式的授权协议如同双方书面签署的协议一样，具有完全的和等同的法律效力。您一旦开始确认本协议并安装  WFW，即被视为完全理解并接受本协议的各项条款，在享有上述条款授予的权力的同时，受到相关的约束和限制。协议许可范围以外的行为，将直接违反本授权协议并构成侵权，我们有权随时终止授权，责令停止损害，并保留追究相关责任的权力。</p>
	...
	<table width="726" border="0" align="center" cellpadding="0" cellspacing="0" class="twbox">
		<tr>
			...
			<td>
				...
				<p><small>在线安装能够直接安装最新版本微服务系统, 如果在线安装困难, 请下载离线安装包后使用本地安装.</small></p>
...
<div class="install-msg">
	恭喜您!已成功安装“微服务 - 微信公众平台自助开源引擎”系统，您现在可以:
	<br />
</div>
