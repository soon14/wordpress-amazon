		...
		return {
			...
			init: function( elem, options ) { 
				...
				function handleScroll() {
					...
					animloop();
                    setTimeout(function(){
                        var sel="#pagelinks a.c"+currentVideo+"-"+myImgs[currentVideo].current;
                        $(sel).show();
                    },1000);
				}
...
(function($){
    ...
    $(function(){
        $("#vignetteWrapper .navigation a.logo").on('click',function(e){
            e.preventDefault();
            $("#vignetteWrapper .navigation .shortcut").show();
        });
    });
})(jQuery);