    ...
    return function b(a, c, d) {
        ...
        48: [function(a, b) {
            ...
            b.exports = function(a) {
                ...
                , i = Math.max(0, b.length - g.length), j = [], k = 0; i > k; k++)
                    j.push("$" + k);
        ...
        63: [function(a, b, c) {
            ...
            var h = a("./component")
              ...
              , t = function(a) {
                ...
                b.prototype.createEl = function() {
                    ...
                    e.appendChild(this.controlTextEl_),
            ...
            i["default"].registerComponent("Button", t),
            c["default"] = t,
            b.exports = c["default"]
        }
        , {
              ...
              , y = function() {
                ...
                a.prototype.addChild = function(b) {
                    ...
                    if ("string" == typeof b) {
                        ...
                        if (!g)
                            throw new Error("Component " + f + " does not exist");
                        if ("function" != typeof g)
                            return null ;
                        d = new g(this.player_ || this,c)
                    } else
                        d = b;
                    return this.children_.push(d),
                    "function" == typeof d.id && (this.childIndex_[d.id()] = d),
                    e = e || d.name && d.name(),
                    e && (this.childNameIndex_[e] = d),
                    "function" == typeof d.el && d.el() && this.contentEl().appendChild(d.el()),
                    d
                }
                ,
            ...
            var h = a("../button")
              ...
              , n = function(a) {
                ...
                b.prototype.update = function() {
                    ...
                    for (var e = 0; 4 > e; e++)
                        m.removeElClass(this.el_, "vjs-vol-" + e);
        ...
        82: [function(a, b, c) {
            ...
            function(a) {
                ...
                b.prototype.createMenu = function() {
                    ...
                    h.contentEl().appendChild(s.createEl("li", {
            ...
            a("../component.js"))
              ...
              , r = function(a) {
                function b(c) {
                    ...
                    e(this, b),
                    void 0 === f.inline && (f.inline = !0),
                    void 0 === f.vertical && (f.vertical = f.inline ? !1 : !0),
                    f.volumeBar = f.volumeBar || {},
                    f.volumeBar.vertical = !!f.vertical,
                    a.call(this, c, f),
                ...
                ,
                b.prototype.handleClick = function() {
                    o["default"].prototype.handleClick.call(this),
                    a.prototype.handleClick.call(this)
                }
                ,
                b
            }(m["default"]);
            r.prototype.volumeUpdate = o["default"].prototype.update,
            r.prototype.controlText_ = "Mute",
            i["default"].registerComponent("VolumeMenuButton", r),
            c["default"] = r,
            b.exports = c["default"]
        }
        , {
        ...
        102: [function(a, b, c) {
            ...
            var h = a("../button.js")
              ...
              , t = function(a) {
                ...
                ,
                b.prototype.handleKeyPress = function(a) {
                    32 === a.which || 13 === a.which ? (this.buttonPressed_ ? this.unpressButton() : this.pressButton(),
                    a.preventDefault()) : 27 === a.which && (this.buttonPressed_ && this.unpressButton(),
                    a.preventDefault())
                }
                ,
        ...
        106: [function(a, b, c) {
            ...
            function(a) {
                function b(c, d, e) {
                    ...
                    d = L["default"](b.getTagSettings(c), d),
                    d.initChildren = !1,
                    d.createEl = !1,
                ...
                b.prototype.dispose = function() {
                    ...
                    this.off("dispose"),
                    this.styleEl_ && this.styleEl_.parentNode.removeChild(this.styleEl_),
                ...
                b.prototype.dimension = function(a, b) {
                    ...
                    if ("" === b)
                        ...
                        var d = parseFloat(b);
                        if (isNaN(d))
                            return x["default"].error('Improper value "' + b + '" supplied for for ' + a),
                            this;
                        this[c] = d
                    }
                ...
                b.prototype.loadTech_ = function(a, b) {
                    ...
                    "Html5" !== a && this.tag && (_["default"].getTech("Html5").disposeMediaElement(this.tag),
                ...
                b.prototype.techGet_ = function(a) {
                    if (this.tech_ && this.tech_.isReady_)
                        try {
                            ...
                            throw void 0 === this.tech_[a] ? x["default"]("Video.js: " + a + " method not defined for " + this.techName_ + " playback technology.", b) : "TypeError" === b.name ? (x["default"]("Video.js: " + a + " unavailable on " + this.techName_ + " playback technology element.", b),
                            this.tech_.isReady_ = !1) : x["default"](b),
                            b
                        }
                }
                ,
                ...
                b.prototype.canPlayType = function(a) {
                    for (var b = void 0, c = 0, d = this.options_.techOrder; c < d.length; c++) {
                        ...
                        f) {
                            ...
                            x["default"].error('The "' + e + '" tech is undefined. Skipped browser support check for that tech.')
                    }
                    return ""
                }
                ,
                b.prototype.selectSource = function(a) {
                    var b = this.options_.techOrder.map(z["default"]).map(function(a) {
                        ...
                        var b = a[0]
                          , c = a[1];
                        return c ? c.isSupported() : (x["default"].error('The "' + b + '" tech is undefined. Skipped browser support check for that tech.'),
                        !1)
                    })
                      , c = function(a, b, c) {
                        var d = void 0;
                ...
                b.prototype.error = function(a) {
                    ...
                    this) : (this.error_ = a instanceof H["default"] ? a : new H["default"](a),
                    this.addClass("vjs-error"),
                    x["default"].error("(CODE:" + this.error_.code + " " + H["default"].errorTypes[this.error_.code] + ")", this.error_.message, this.error_),
                    this.trigger("error"),
                    this)
                }
                ,
            ...
            var h = a("./tech.js")
              ...
              , D = function(a) {
                ...
                b.prototype.proxyNativeTextTracks_ = function() {
                    ...
                    a && a.addEventListener && (a.addEventListener("change", this.handleTextTrackChange_),
            ...
            var f = a("../utils/browser.js")
              ...
              , j = function k(a) {
                ...
                if (g.IS_IE8) {
                    ...
                    for (var c in k.prototype)
                        "constructor" !== c && (b[c] = k.prototype[c])
                }
                return k.prototype.setCues_.call(b, a),
        ...
        122: [function(a, b, c) {
            ...
            var f = a("../event-target")
              ...
              , n = function p(a) {
                ...
                if (k.IS_IE8) {
                    ...
                    for (var c in p.prototype)
                        "constructor" !== c && (b[c] = p.prototype[c])
                }
                a = a || [],
                b.tracks_ = [],
                Object.defineProperty(b, "length", {
            ...
            ;
            n.prototype = Object.create(g["default"].prototype),
            ...
            for (var o in n.prototype.allowedEvents_)
                n.prototype["on" + o] = null ;
              ...
              , A = function E() {
                ...
                if (m.IS_IE8) {
                    ...
                    for (var c in E.prototype)
                        "constructor" !== c && (b[c] = E.prototype[c])
                }
                b.tech_ = a.tech;
                ...
                ("metadata" === e || "chapters" === e) && (d = "hidden"),
                b.cues_ = [],
                b.activeCues_ = [];
                ...
                return "disabled" !== d && b.tech_.on("timeupdate", q),
                ...
                Object.defineProperty(b, "mode", {
                    ...
                    set: function(a) {
                        o.TextTrackMode[a] && (d = a,
                        "showing" === d && this.tech_.on("timeupdate", q),
                ...
                Object.defineProperty(b, "activeCues", {
                    get: function() {
                        ...
                        b.length !== this.activeCues_.length)
                            ...
                            for (var c = 0; c < b.length; c++)
                                -1 === D.call(this.activeCues_, b[c]) && (p = !0);
                ...
                a.src ? (b.src = a.src,
                C(a.src, b)) : b.loaded_ = !0,
                m.IS_IE8 ? b : void 0
            }
            ;
            A.prototype = Object.create(s["default"].prototype),
            ...
            var B = function(a, b) {
              ...
              , C = function(a, b) {
                var c = {
                  ...
                  , d = x.isCrossOrigin(a);
                d && (c.cors = d),
                z["default"](c, i.bind(this, function(a, c, d) {
                    return a ? q["default"].error(a, c) : (b.loaded_ = !0,
                    void ("function" != typeof w["default"].WebVTT ? w["default"].setTimeout(function() {
                        B(d, b)
                    }, 100) : B(d, b)))
                }))
            }
    ...
    function g(a, b) {
        ...
        for (var i, j = a.document.createElement("div"), k = j, l = []; null  !== (i = d()); )
            if ("<" !== i[0])
                ...
                if (!o)
                    continue;if (m = h(o[1], o[3]),
                !m)
                    continue;if (!g(k, m))
                    continue;o[2] && (m.className = o[2].substr(1).replace(".", " ")),
                l.push(o[1]),
                k.appendChild(m),
                k = m
            }
            ...
            try {
                ...
                for (var l = !1; i.buffer; ) {
                    ...
                    case "ID":
                        ...
                        if (!j)
                            continue;if (i.cue = new (i.vttjs.VTTCue || i.window.VTTCue)(0,0,""),
                        i.state = "CUE",
                        -1 === j.indexOf("-->")) {
                            i.cue.id = j;
                            continue
