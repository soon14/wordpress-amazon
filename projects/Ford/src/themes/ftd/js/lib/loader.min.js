...
/*! hasflash.js version 1.0 gbaker | Flash Detect from MIT/GPL - http://jquery.thewikies.com/swfobject/ | */
(function(b,c){if(!b.hasflashjs){b.hasflashjs=1;try{var a=c.description||function(){return(new c("ShockwaveFlash.ShockwaveFlash")).GetVariable("$version")}()}catch(f){a="Unavailable"}b=a.match(/\d+/g)||[0];a=parseInt(b[0],10)||0;b="has-js js";var d=document.documentElement;if(!isNaN(a)&&a>1&&a<100){b+=" has-flash";for(a=a;a>=8;a--)b+=" flash-gt-eq-"+a}(function(e){d.className+=(d.className==""?"":" ")+e})(b)}})(window,navigator.plugins["Shockwave Flash"]||window.ActiveXObject);
/*! Old School load listener. See https://github.com/getify/LABjs/issues/3 for reasons. */
var isWindowLoaded=false;(function(){var a=function(fn){if(typeof window.addEventListener!='undefined'){window.addEventListener('load',fn,false);}else if(typeof document.addEventListener!='undefined'){document.addEventListener('load',fn,false);}else if(typeof window.attachEvent!='undefined'){ window.attachEvent('onload',fn);}else{var oldfn=window.onload;if(typeof window.onload!='function'){window.onload=fn;}else{window.onload=function(){oldfn();fn();};}}};a(function(){isWindowLoaded=true;});}());