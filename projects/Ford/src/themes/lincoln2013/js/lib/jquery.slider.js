    ...
    $.fn.slideshow = function(o) {
        ...
        return this.each(function(){
            ...
            var init = function() {
                ...
                jiathis_config.pic = 'http://' + document.domain + $slider.children('li:first').children('.full-width-bg').attr("src");
            ...
            var updateJiathis = function() {
                ...
                if(typeof jiathis_config !=='undefined') {
                    ...
                    jiathis_config.pic = 'http://' + document.domain + currentIMG.attr('src');
                }
